...
class MaeDecoderPerBlock(SingleModelBase):
    """ MAEDecoder but with an initial norm to compensate the norm missing after the last encoder layer """
    def __init__(
            self,
            dim,
            depth,
        ...
        # embed
        self.encoder_norm = norm_ctor(encoder_dim)
    ...
    def model_specific_initialization(self):
        ...
        # norms
        init_norm_as_noaffine(self.encoder_norm)
